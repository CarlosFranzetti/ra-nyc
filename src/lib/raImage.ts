 ...
 *
 * Used only as a fallback when the CDN refuses a direct browser request — see
 * `EventImage` and `api/image.ts`.
 */
export function proxiedRAImageUrl(absoluteUrl: string): string {
